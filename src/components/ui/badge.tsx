  ...
  "inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        link: 'border-transparent bg-link text-link-foreground hover:bg-link-hover',
        active: 'border-transparent bg-active text-active-foreground hover:bg-active-hover',
